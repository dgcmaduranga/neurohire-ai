...
const benefits = [
  {
    ...
    text: "Extract skills and experience automatically.",
  },
  {
    icon: ShieldCheck,
    title: "Secure Workspace",
    text: "Protected workflows for recruiters.",
  },
  {
    icon: Zap,
    title: "Faster Decisions",
    text: "Shortlist candidates using AI insights.",
  },
];
    ...
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-white via-blue-50 to-cyan-50 px-4 py-5 sm:px-6">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-stretch gap-7 py-6 lg:min-h-[calc(100vh-90px)] lg:grid-cols-2">
        ...
        >
          ...
          <div className="absolute bottom-8 left-8 h-5 w-5 rounded-full bg-violet-500 shadow-[0_0_45px_rgba(139,92,246,0.9)]" />
          ...
          <div className="relative flex w-full flex-col justify-center">
            ...
            <p className="mt-5 max-w-lg text-base leading-8 text-blue-100">
              Create your account to analyze resumes, generate ATS scores,
              conduct AI interviews and manage hiring faster.
            </p>
          ...
          >
            <div className="flex h-full flex-col justify-center p-7 sm:p-9 lg:p-12">
              ...
              <div className="mx-auto w-full max-w-lg">
                ...
                <button className="mt-6 flex w-full items-center justify-center gap-3 rounded-2xl border border-blue-100 bg-white px-5 py-3.5 text-sm font-black text-slate-800 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
                  <GoogleIcon />
